...
Element buildPage4() {
  ...
  final word1 = document.createElementNS(svgcdn, 'text')..text = "void "..setAttribute('x', '33')..setAttribute('y', '30')..setAttribute('font-size', '5');

final word2_input = document.createElementNS(svgcdn, 'foreignObject')
  ..setAttribute('x', '44')
  ..setAttribute('y', '25')
  ..setAttribute('width', '19')
  ..setAttribute('height', '7');

final word2_textbox = InputElement()
  ..style.width = "19px"
  ..style.height = "7px"
  ...
  final word1_2 = document.createElementNS(svgcdn, 'text')..text =  "{}"..setAttribute('x', '65')..setAttribute('y', '30')..setAttribute('font-size', '5');
  word2_input.append(word2_textbox);
...
btn.onClick.listen((_) {
  ...
  ..append(word1)..append(word2_input)..append(word1_2)..append(checkBtn)..append(sidenumber);
