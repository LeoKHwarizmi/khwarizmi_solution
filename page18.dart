...
Element buildPage18() {
  ...
  final word1_bg = document.createElementNS(svgcdn, 'rect')..setAttribute('x', '30')..setAttribute('y', '25')..setAttribute('width', '100')..setAttribute('height', '7')..setAttribute('rx', '2')..setAttribute('fill', 'PapayaWhip');
  final word1 = document.createElementNS(svgcdn, 'text')..text = "final image = Element.tag('img')"..setAttribute('x', '31')..setAttribute('y', '30')..setAttribute('font-size', '5');
  final word2_bg = document.createElementNS(svgcdn, 'rect')..setAttribute('x', '30')..setAttribute('y', '33')..setAttribute('width', '100')..setAttribute('height', '7')..setAttribute('rx', '2')..setAttribute('fill', 'PapayaWhip');
  final word2 = document.createElementNS(svgcdn, 'text')..text = "..setAttribute("..setAttribute('x', '31')..setAttribute('y', '38')..setAttribute('font-size', '5');
  final word20_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '59')..setAttribute('y', '33')..setAttribute('width', '17')..setAttribute('height', '7');
  final word20_textbox = InputElement()..style.width = "17px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word20_input";
  word20_input.append(word20_textbox);
  final word2_2 = document.createElementNS(svgcdn, 'text')..text = ", 'snake.png')"..setAttribute('x', '77')..setAttribute('y', '38')..setAttribute('font-size', '5');
  
  final word3_bg = document.createElementNS(svgcdn, 'rect')..setAttribute('x', '30')..setAttribute('y', '41')..setAttribute('width', '100')..setAttribute('height', '7')..setAttribute('rx', '2')..setAttribute('fill', 'PapayaWhip');
  final word3 = document.createElementNS(svgcdn, 'text')..text = "..setAttribute("..setAttribute('x', '31')..setAttribute('y', '46')..setAttribute('font-size', '5');
  final word21_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '59')..setAttribute('y', '41')..setAttribute('width', '17')..setAttribute('height', '7');
  final word21_textbox = InputElement()..style.width = "17px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word21_input";
  word21_input.append(word21_textbox);
  final word3_2 = document.createElementNS(svgcdn, 'text')..text = ", 'image')"..setAttribute('x', '77')..setAttribute('y', '46')..setAttribute('font-size', '5');
...
void main() {
final image = Element.tag('img')
  ..setAttribute('src', 'snake.png')
...
*/
  ...
  svg..append(practice2a)..append(practice2a_title)..append(word1_bg)..append(word1)
  ..append(word2_bg)..append(word2)..append(word20_input)..append(word2_2)
  ..append(word3_bg)..append(word3)..append(word21_input)..append(word3_2)
  ..append(checkBtn)..append(sidenumber);
