...
Element buildPage11() {
  ...
  final course_number = document.createElementNS(svgcdn, 'text')..text = '06'..setAttribute('x', '175')..setAttribute('y', '30')..setAttribute('font-size', '30')..setAttribute('font-weight', '1000')..setAttribute('font-family', 'Impact')..setAttribute('fill', 'CadetBlue');
  final course_title = document.createElementNS(svgcdn, 'text')..text = '.body'..setAttribute('x', '15')..setAttribute('y', '20')..setAttribute('font-size', '10')..setAttribute('font-weight', '800')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'RoyalBlue');
  final course_subtitle = document.createElementNS(svgcdn, 'text')..text = 'Headings'..setAttribute('x', '38')..setAttribute('y', '30')..setAttribute('font-size', '10')..setAttribute('font-weight', '900')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'white');
  ...
  final practice2a_wort1 = document.createElementNS(svgcdn, 'text')..text = 'body'..setAttribute('x', '30')..setAttribute('y', '163')..setAttribute('font-size', '5')..setAttribute('font-weight', '900')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'black');
  ...
  final practice2a_description1 = document.createElementNS(svgcdn, 'text')..text = 'The visible part of the HTML document.'..setAttribute('x', '35')..setAttribute('y', '173')..setAttribute('font-size', '5')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'SteelBlue');
  
  final practice2a_wort2 = document.createElementNS(svgcdn, 'text')..text = 'Headings'..setAttribute('x', '30')..setAttribute('y', '188')..setAttribute('font-size', '5')..setAttribute('font-weight', '900')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'black');
  ...
  final practice2a_description2 = document.createElementNS(svgcdn, 'text')..text = 'are titles or subtitles that you want to display on a webpage.'..setAttribute('x', '35')..setAttribute('y', '198')..setAttribute('font-size', '5')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'SteelBlue');
...
void showOnboarding() {
  ...
  ..src = "https://www.youtube.com/embed/96fSBkZx83s?si=vVT34iJixe54gqGU"
    ..width = "100%"
    ..height = "100%"
    ..style.border = "none"
