...
Element buildPage12() {
  ...
  final word1 = document.createElementNS(svgcdn, 'text')..text = "final section_heading = "..setAttribute('x', '31')..setAttribute('y', '30')..setAttribute('font-size', '5');
  final word11_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '79')..setAttribute('y', '25')..setAttribute('width', '38')..setAttribute('height', '7');
  final word11_textbox = InputElement()..style.width = "38px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word11_input";
  word11_input.append(word11_textbox);
  final word1_1 = document.createElementNS(svgcdn, 'text')..text = "('h1').."..setAttribute('x', '118')..setAttribute('y', '30')..setAttribute('font-size', '5');
  final word11_1_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '131')..setAttribute('y', '25')..setAttribute('width', '15')..setAttribute('height', '7');
  final word11_1_textbox = InputElement()..style.width = "15px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word11_1_input";
  word11_1_input.append(word11_1_textbox);
  ...
  final word12_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '52')..setAttribute('y', '33')..setAttribute('width', '19')..setAttribute('height', '7');
  final word12_textbox = InputElement()..style.width = "19px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word12_input";
  word12_input.append(word12_textbox);
  final word2_1 = document.createElementNS(svgcdn, 'text')..text = "!.."..setAttribute('x', '72')..setAttribute('y', '38')..setAttribute('font-size', '5');
  final word13_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '77')..setAttribute('y', '33')..setAttribute('width', '70')..setAttribute('height', '7');
  final word13_textbox = InputElement()..style.width = "70px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word13_input";
  word13_input.append(word13_textbox);
...
btn.onClick.listen((_) {
  final answers = {
    "word11_input": "Element.tag",
    "word11_1_input": "text",
    "word12_input": "body",
    "word13_input": "append(section_heading);",
  };
  ...
  ..append(word1)..append(word1_1)..append(word11_input)..append(word1)..append(word11_1_input)..append(word2)..append(word12_input)..append(word13_input)..append(word2_1)..append(checkBtn)..append(sidenumber);
