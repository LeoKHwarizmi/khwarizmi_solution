...
Element buildPage5() {
  ...
  final course_number = document.createElementNS(svgcdn, 'text')..text = '03'..setAttribute('x', '175')..setAttribute('y', '30')..setAttribute('font-size', '30')..setAttribute('font-weight', '1000')..setAttribute('font-family', 'Impact')..setAttribute('fill', 'CadetBlue');
  ...
  final course_subtitle = document.createElementNS(svgcdn, 'text')..text = 'comments'..setAttribute('x', '38')..setAttribute('y', '30')..setAttribute('font-size', '10')..setAttribute('font-weight', '900')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'white');
  ...
  final practice2a_wort1 = document.createElementNS(svgcdn, 'text')..text = 'single line comment'..setAttribute('x', '30')..setAttribute('y', '163')..setAttribute('font-size', '5')..setAttribute('font-weight', '900')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'black');
  ...
  final practice2a_description1 = document.createElementNS(svgcdn, 'text')..text = 'any text between // and the end of the line is ignored by the compiler.'..setAttribute('x', '35')..setAttribute('y', '173')..setAttribute('font-size', '5')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'SteelBlue');
  
  final practice2a_wort2 = document.createElementNS(svgcdn, 'text')..text = 'multi line comment'..setAttribute('x', '30')..setAttribute('y', '188')..setAttribute('font-size', '5')..setAttribute('font-weight', '900')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'black');
  ...
  final practice2a_description2 = document.createElementNS(svgcdn, 'text')..text = 'and any text between /* and */ will be ignored by the compiler.'..setAttribute('x', '35')..setAttribute('y', '198')..setAttribute('font-size', '5')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'SteelBlue');
...
void showOnboarding() {
  ...
  ..src = "https://www.youtube.com/embed/VwPPj9qmc_k?si=J0DEyBf7tEq6iv0g"
    ..width = "100%"
    ..height = "100%"
    ..style.border = "none"
