...
Element buildPage10() {
  ...
  final word1 = document.createElementNS(svgcdn, 'text')..text = "final favicon = "..setAttribute('x', '31')..setAttribute('y', '30')..setAttribute('font-size', '5');
  final word9_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '62')..setAttribute('y', '25')..setAttribute('width', '38')..setAttribute('height', '7');
  final word9_textbox = InputElement()..style.width = "38px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word9_input";
  word9_input.append(word9_textbox);
  final word1_1 = document.createElementNS(svgcdn, 'text')..text = "('link')"..setAttribute('x', '100')..setAttribute('y', '30')..setAttribute('font-size', '5');
  ...
  final word2 = document.createElementNS(svgcdn, 'text')..text = ".."..setAttribute('x', '31')..setAttribute('y', '38')..setAttribute('font-size', '5');
  final word10_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '34')..setAttribute('y', '33')..setAttribute('width', '38')..setAttribute('height', '7');
  final word7_textbox = InputElement()..style.width = "38px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word10_input";
  word10_input.append(word7_textbox);
  final word2_1 = document.createElementNS(svgcdn, 'text')..text = "('href', 'favicon.ico');"..setAttribute('x', '72')..setAttribute('y', '38')..setAttribute('font-size', '5');
...
btn.onClick.listen((_) {
  final answers = {
    "word9_input": "Element.tag",
    "word10_input": "setAttribute",
  };
  ...
  ..append(word1)..append(word1_1)..append(word9_input)..append(word1)..append(word10_input)..append(word2)..append(word2_1)..append(checkBtn)..append(sidenumber);
