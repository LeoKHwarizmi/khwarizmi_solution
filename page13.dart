...
Element buildPage13() {
  ...
  final course_number = document.createElementNS(svgcdn, 'text')..text = '07'..setAttribute('x', '175')..setAttribute('y', '30')..setAttribute('font-size', '30')..setAttribute('font-weight', '1000')..setAttribute('font-family', 'Impact')..setAttribute('fill', 'CadetBlue');
  ...
  final course_subtitle = document.createElementNS(svgcdn, 'text')..text = 'Paragraphs'..setAttribute('x', '38')..setAttribute('y', '30')..setAttribute('font-size', '10')..setAttribute('font-weight', '900')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'white');
  ...
  final practice2a_wort2 = document.createElementNS(svgcdn, 'text')..text = 'Paragraphs'..setAttribute('x', '30')..setAttribute('y', '188')..setAttribute('font-size', '5')..setAttribute('font-weight', '900')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'black');
  ...
  final practice2a_description2 = document.createElementNS(svgcdn, 'text')..text = 'A paragraph is usually a block of text.'..setAttribute('x', '35')..setAttribute('y', '198')..setAttribute('font-size', '5')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'SteelBlue');
...
void showOnboarding() {
  ...
  ..src = "https://www.youtube.com/embed/gdlJ3eLS8rk?si=wzgh8K2eoeis6UAt"
    ..width = "100%"
    ..height = "100%"
    ..style.border = "none"
