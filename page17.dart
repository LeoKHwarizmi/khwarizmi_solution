...
Element buildPage17() {
  ...
  final course_number = document.createElementNS(svgcdn, 'text')..text = '09'..setAttribute('x', '175')..setAttribute('y', '30')..setAttribute('font-size', '30')..setAttribute('font-weight', '1000')..setAttribute('font-family', 'Impact')..setAttribute('fill', 'CadetBlue');
  ...
  final course_subtitle = document.createElementNS(svgcdn, 'text')..text = 'Images'..setAttribute('x', '38')..setAttribute('y', '30')..setAttribute('font-size', '10')..setAttribute('font-weight', '900')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'white');
  ...
  final practice2a_wort2 = document.createElementNS(svgcdn, 'text')..text = 'images'..setAttribute('x', '30')..setAttribute('y', '188')..setAttribute('font-size', '5')..setAttribute('font-weight', '900')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'black');
  ...
  final practice2a_description2 = document.createElementNS(svgcdn, 'text')..text = 'Images can improve the design and the appearance of a web page.'..setAttribute('x', '35')..setAttribute('y', '198')..setAttribute('font-size', '5')..setAttribute('font-family', 'Times New Roman')..setAttribute('fill', 'SteelBlue');
...
void showOnboarding() {
  ...
  ..src = "https://www.youtube.com/embed/exPtONWLmlE?si=xU6JnN8sliQkwYza"
    ..width = "100%"
    ..height = "100%"
    ..style.border = "none"
