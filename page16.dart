...
Element buildPage16() {
  ...
  final word1 = document.createElementNS(svgcdn, 'text')..text = "final link = Element.tag('a')"..setAttribute('x', '31')..setAttribute('y', '30')..setAttribute('font-size', '5');
  ...
  final word18_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '31')..setAttribute('y', '33')..setAttribute('width', '19')..setAttribute('height', '7');
  final word18_textbox = InputElement()..style.width = "19px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word18_input";
  word18_input.append(word18_textbox);
  final word2 = document.createElementNS(svgcdn, 'text')..text = " = 'This is a link'"..setAttribute('x', '52')..setAttribute('y', '38')..setAttribute('font-size', '5');
  ...
  final word2_1 = document.createElementNS(svgcdn, 'text')..text = "..setAttribute("..setAttribute('x', '31')..setAttribute('y', '46')..setAttribute('font-size', '5');
  
  final word19_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '59')..setAttribute('y', '41')..setAttribute('width', '17')..setAttribute('height', '7');
  final word19_textbox = InputElement()..style.width = "17px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word19_input";
  word19_input.append(word19_textbox);
  final word2_2 = document.createElementNS(svgcdn, 'text')..text = ", 'https://example.com');"..setAttribute('x', '77')..setAttribute('y', '46')..setAttribute('font-size', '5');
...
btn.onClick.listen((_) {
  ...
  ..append(word1)..append(word1)..append(word2)..append(word18_input)..append(word3_bg)..append(word19_input)..append(word2_2)..append(word2_1)..append(checkBtn)..append(sidenumber);
