...
Element buildPage6() {
  ...
  final word3_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '31')..setAttribute('y', '25')..setAttribute('width', '10')..setAttribute('height', '7');
  final word3_textbox = InputElement()..style.width = "10px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word3_input";
  final word1 = document.createElementNS(svgcdn, 'text')..text = "Sinle Line Comment"..setAttribute('x', '43')..setAttribute('y', '30')..setAttribute('font-size', '5');
  word3_input.append(word3_textbox);
  ...
  final word4_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '31')..setAttribute('y', '33')..setAttribute('width', '10')..setAttribute('height', '7');
  final word4_textbox = InputElement()..style.width = "10px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word4_input";
  word4_input.append(word4_textbox);

  final word2 = document.createElementNS(svgcdn, 'text')..text = "multi Lines Comment"..setAttribute('x', '43')..setAttribute('y', '38')..setAttribute('font-size', '5');
  final word5_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '89')..setAttribute('y', '33')..setAttribute('width', '10')..setAttribute('height', '7');
  final word5_textbox = InputElement()..style.width = "10px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word5_input";
  word5_input.append(word5_textbox);
...
btn.onClick.listen((_) {
  ...
  ..append(word1)..append(word3_input)..append(word1)..append(word4_input)..append(word2)..append(word5_input)..append(checkBtn)..append(sidenumber);
