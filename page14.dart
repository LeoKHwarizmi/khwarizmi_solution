...
Element buildPage14() {
  ...
  final word1 = document.createElementNS(svgcdn, 'text')..text = "final paragraph = "..setAttribute('x', '31')..setAttribute('y', '30')..setAttribute('font-size', '5');
  final word14_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '67')..setAttribute('y', '25')..setAttribute('width', '38')..setAttribute('height', '7');
  final word14_textbox = InputElement()..style.width = "38px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word14_input";
  word14_input.append(word14_textbox);
  final word1_1 = document.createElementNS(svgcdn, 'text')..text = "('p').."..setAttribute('x', '105')..setAttribute('y', '30')..setAttribute('font-size', '5');
  final word15_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '115')..setAttribute('y', '25')..setAttribute('width', '15')..setAttribute('height', '7');
  final word15_textbox = InputElement()..style.width = "15px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word15_input";
  word15_input.append(word15_textbox);
  ...
  final word16_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '52')..setAttribute('y', '33')..setAttribute('width', '19')..setAttribute('height', '7');
  final word16_textbox = InputElement()..style.width = "19px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word16_input";
  word16_input.append(word16_textbox);
  final word2_1 = document.createElementNS(svgcdn, 'text')..text = "!.."..setAttribute('x', '72')..setAttribute('y', '38')..setAttribute('font-size', '5');
  final word17_input = document.createElementNS(svgcdn, 'foreignObject')..setAttribute('x', '77')..setAttribute('y', '33')..setAttribute('width', '70')..setAttribute('height', '7');
  final word17_textbox = InputElement()..style.width = "70px"..style.height = "7px"..style.fontSize = "5.5px"..style.border = "1px solid black"..style.borderRadius = "0"..style.outline = "none"..style.boxSizing = "border-box"..id = "word17_input";
  word17_input.append(word17_textbox);
...
btn.onClick.listen((_) {
  final answers = {
    "word14_input": "Element.tag",
    "word15_input": "text",
    "word16_input": "body",
    "word17_input": "append(paragraph);",
  };
  ...
  ..append(word1)..append(word1_1)..append(word14_input)..append(word1)..append(word15_input)..append(word2)..append(word16_input)..append(word17_input)..append(word2_1)..append(checkBtn)..append(sidenumber);
